...
void skills(){
    ...
    chassis.turnToPoint(-36,0,1000,{.minSpeed=3,.earlyExitRange=5});
    set_intake_speed(127);
    ...
    //mogo 2 get 1st ring
    chassis.turnToPoint(39,32,1000,{.minSpeed=5,.earlyExitRange=3},false);
    // set_intake_speed(127,false);
    fast_move(39,32,2000,true);
    

    //mogo 2 get ring 2 move to half way point to avoid hang post
    chassis.turnToPoint(59,58,1000,{.minSpeed=5,.earlyExitRange=3},false);
    ...
    set_intake_speed(127);
    chassis.turnToPoint(62,0,1000,{.minSpeed=3,.earlyExitRange=5});
    chassis.moveToPoint(62,0,2000,{.minSpeed=50,.earlyExitRange=20});
    chassis.moveToPoint(62,0,2000,{.maxSpeed=30},false);
    
    //mogo 2 get last ring and set up to drop off mogo
    chassis.turnToPoint(72, 4, 2000, {.minSpeed=5,.earlyExitRange=3},false);
    chassis.moveToPoint(72,4,2000,{.minSpeed=5,.earlyExitRange=3});
    ...
    chassis.turnToPoint(-9.5,76,1000);
    chassis.moveToPoint(-9.5,76,4000);
    ...
    //get mogo 3
    chassis.turnToPoint(14,108,1000,{.forwards=false});
    chassis.moveToPoint(14,108,4000,{.forwards=false,.maxSpeed=60});
    while(!mogo_seated() && chassis.isInMotion()) pros::delay(10);
    pros::delay(100);
    mogo.set_value(false);
    skills_task3.notify();
    ...
    //mogo 3 get 5th ring
    chassis.turnToPoint(57,109,1000,{.minSpeed=3,.earlyExitRange=5});
    fast_move(57,109,2000,true); 
    //mogo 3 get 6th ring
    ...
    chassis.moveToPoint(74,89,2000,{.forwards=false,.minSpeed=5,.earlyExitRange=3});

    //mogo 3 swipe corner
    // chassis.turnToHeading(10,1000,{.minSpeed=5,.earlyExitRange=3},false);
    chassis.turnToPoint(75,122,1000,{.minSpeed=5,.earlyExitRange=3});
    swiper.set_value(true);
    pros::delay(500);
    // chassis.moveDistance(30,2000,{.minSpeed=5,.earlyExitRange=3});
    chassis.moveToPoint(75, 122, 2000,{.minSpeed=5,.earlyExitRange=3});
